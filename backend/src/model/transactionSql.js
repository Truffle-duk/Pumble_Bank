// 거래내역 입력
export const insertRecord = "INSERT INTO transaction (t_date, counterparty, amount, type, description, account_id) VALUES (now(), ?, ?, ?, ?, (select account_id from account_pumble_mapping where group_uuid = ?));";
// 전체 잔액 조회
